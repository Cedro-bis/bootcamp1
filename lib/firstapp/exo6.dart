...
class ListOfContacts extends StatelessWidget {
  ...
  final List<Contact> Contacts = const [
    Contact(
      name: "Nsimire",
      number: "0998766726",
      image: AssetImage("lib/image/cedro.jpg"),
    ),
    Contact(
      name: "Lydia",
      number: "0978938473",
      image: AssetImage("lib/image/3.png"),
    ),
    Contact(
      name: "Patrick",
      number: "0927376834",
      image: AssetImage("lib/image/2.jpg"),
    ),
    Contact(
      name: "Harmonize",
      number: "0998764479",
      image: AssetImage("lib/image/1.jpg"),
    ),
    Contact(
      name: "Fally",
      number: "0997484362",
      image: AssetImage("lib/image/4.jpg"),
    ),
    Contact(
      name: "Sweet",
      number: "0976264362",
      image: AssetImage("lib/image/5.jpg"),
    ),
    Contact(
      name: "Deborah",
      number: "0976264362",
            ...
            child: InkWell(
              ...
              child: Card(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    SnackBar(
                      content: Text('Vous avez cliqué sur'),
